//! This example shows painting a  curve using common-piet crate and
...
fn main() {
    ...
    let points = [
        ...
        Point2D::new((2.0 / 3.0) * WIDTH as f32, HEIGHT as f32),
        Point2D::new(WIDTH as f32, 0.0),
    ];
    let curve = generator.curve::<f32>(&points);
    ...
    bitmap.save_to_file("curve.png").expect("file save error");
}
